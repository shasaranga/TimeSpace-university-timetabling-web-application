...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li >
                <a href="searchStudentTimeTableForStudent.jsp">Search Student Timetable</a>
            </li>
            <li class="active">
                <a href="searchLecturerTimeTableForStudent.jsp">Search Lecturer Timetable</a>
            </li>
            <li>
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="form-group">
                        <select name="lecturerID" id="lecturerID" class="form-control" required>
                            ...
                            <%
                                DAO dao = new DAO();
                                List<Lecturer> listLecturer = dao.getAllLecturers();
                ...
                <div class="col-lg-2">
                    <div class="form-group">
                        ...
                        <input type="hidden" value="lecturer" name="userType" id="userType">
                        <input type="hidden" value="commonLecturerViewForStudent" name="viewType" id="viewType">
