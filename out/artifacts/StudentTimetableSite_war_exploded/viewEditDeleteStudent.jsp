...
<%--                    <input type="hidden" value="filterStudentByID" name="action">--%>
                    <input class="form-control mr-sm-2" type="search" id ="searchInput" onkeyup="myFunction()"  placeholder="Filter Student by Student ID" aria-label="Search">
...
<%--        </c:if>--%>
        ...
        <table class="table" id ="studentTable" style="color:black;">
            ...
            <tr>
                ...
                <td>
                    <button id="btnViewLicence2" onclick="sendEditSource('<%=student.getStudentID()%>', '<%=student.getAddress()%>', '<%=student.getEmail()%>', '<%=student.getPassword()%>', '<%=student.getMobileNumber()%>', '<%=student.getEmergencyNum()%>')" type ="button"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id ="modalBODY">
                            <form action="StudentServlet" method="GET">
                                ...
                                <input type="hidden" value="" id = "selectedStudentID" name="selectedStudentID">
...
<script>
    ...
    function sendEditSource(data1,data2,data3,data4,data5,data6) {
        ...
        var pass = data4;
        console.log("Student Password :" + pass);
        var mobileNum = data5;
