...
<%--        </c:if>--%>
        ...
        <table class="table" id ="studentTable" style="color:black;">
            ...
            <%
                ...
                DAO dao = new DAO();
                List<Course> coursesList = dao.getCourses();
            ...
            <c:url var ="deleteLink" value ="CourseServlet">
                <c:param name="action" value="Delete"/>
                <c:param name="courseID" value="<%=String.valueOf(course.getId())%>"/>
            ...
            <tr>
                ...
                <td><%=course.getCourseField()%></td>


                <td>
                    <button id="btnViewLicence2" onclick="sendEditSource('<%=course.getId()%>', '<%=course.getCourseName()%>', '<%=course.getCourseField()%>')" type ="button"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style ="color:black;" for="courseName" class="label">Course Name :</label>
                                            <input type="text" class="form-control" id="courseName" name="courseName" maxlength="100" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style ="color:black;" for="courseField" class="label">Course Field :</label>
                                            <input type="text" class="form-control" id="courseField" name="courseField" maxlength="100" required>
                                        </div>
                                    </div>
                                </div>
