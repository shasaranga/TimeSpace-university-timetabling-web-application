        ...
        <section class="scheduleClassFormWrappper ">
            <div class="container row no-gutters justify-content-start align-items-center ">
                <div class="card-wrapper navChangeLimit">
                    <div class="col-lg-6 col-md-6 mt-0 mt-md-6 addCourseFormImage"></div>
                    <form class="scheduleCass-form" action="CourseServlet" method="get" id="regForm">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="courseName" name="courseName" maxlength="10" required>
                            </div>

                        </div>
                        <div class="form-group">
                            <label for="courseField" class="label">Course Field:</label>
                            <input type="text" class="form-control" id="courseField" name="courseField" required>
                        </div>
