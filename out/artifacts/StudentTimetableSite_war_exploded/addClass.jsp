        ...
        <section class="scheduleClassFormWrappper ">
            <div class="container row no-gutters justify-content-start align-items-center ">
                <div class="card-wrapper navChangeLimit">
                    ...
                    <form class="scheduleCass-form" action="ClassServlet" method="get" id="regForm">
                        <h2 class="h2">Add New Class</h2>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <label for="className" class="label">Class Name :</label>
                                <input type="text" class="form-control" id="className" name="className" maxlength="10" required>
                            </div>

                        </div>
                        <div class="form-group">
                            <label for="floorLevel" class="label">Floor Level:</label>
                            <input type="number" class="form-control" id="floorLevel" name="floorLevel" required>

                        </div>
                        <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="isAllocatedForModule" id="isAllocatedForModule">
                            <label class="form-check-label" for="isAllocatedForModule">
                                Is Allocated For a Course Module
                            </label>
                        </div>
                        </div>
