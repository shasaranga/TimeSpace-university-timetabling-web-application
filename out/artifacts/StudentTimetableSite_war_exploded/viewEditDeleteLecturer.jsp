...
<%@ page import="StudentTimetablingSystem.model.Student" %>
...
<html>
<head>
    <title>Manage Lecturer Information</title>
...
<%--                    <input type="hidden" value="filterStudentByID" name="action">--%>
                    <input class="form-control mr-sm-2" type="search" id ="searchInput" onkeyup="myFunction()"  placeholder="Filter Lecturer by Lecturer ID" aria-label="Search">
...
<%--        </c:if>--%>
        ...
        <table class="table" id ="studentTable" style="color:black;">
            ...
            <%
                ...
                DAO dao = new DAO();
                List<Lecturer> lecturerList = dao.getAllLecturers();
            ...
            <c:url var ="deleteLink" value ="LecturerServlet">
                <c:param name="action" value="Delete"/>
                <c:param name="UserID" value="<%=lecturer.getLecturerID()%>"/>
            ...
            <tr>
                ...
                <td><%=lecturer.getContactNumber()%></td>

                <td>
                    <button id="btnViewLicence2" onclick="sendEditSource('<%=lecturer.getLecturerID()%>', '<%=lecturer.getAddress()%>', '<%=lecturer.getEmail()%>', '<%=lecturer.getPassword()%>', '<%=lecturer.getContactNumber()%>', '<%=lecturer.getEmergencyNum()%>')" type ="button"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id ="modalBODY">
                            <form action="LecturerServlet" method="GET">
                                ...
                                <input type="hidden" value="" id = "selectedLecturerID" name="selectedLecturerID">
...
<script>
    ...
    function sendEditSource(data1,data2,data3,data4,data5,data6) {
        ...
        document.getElementById('selectedLecturerID').value = selectedStudentID;
