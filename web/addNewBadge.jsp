        ...
        <section class="scheduleClassFormWrappper ">
            <div class="container row no-gutters justify-content-start align-items-center ">
                <div class="card-wrapper navChangeLimit">
                    <div class="col-lg-6 col-md-6 mt-0 mt-md-6 badgeFormImage"></div>
                    <form class="scheduleCass-form" action="BadgesServlet" method="get" id="regForm">
                        <h2 class="h2">Add New Badge</h2>
                        ...
                        <div class="form-group">
                            ...
                            <label for="badgeName" class="label">Badge Name :</label>
                            <input type="text" class="form-control" id="badgeName" name="badgeName" maxlength="10" required>
                        </div>

                        <div class="form-group">
                            <label for="badgeYear" class="label">Badge Year:</label>
