...
<html>
<head>
    <title>Register Timetabler</title>
        ...
        <section class="scheduleClassFormWrappper ">
            <div class="container row no-gutters justify-content-start align-items-center ">
                <div class="card-wrapper navChangeLimit">
                    <div class="col-lg-6 col-md-6 mt-0 mt-md-6 timetablerRegFormImage"></div>
                    <form class="scheduleCass-form" action="TimetablerServlet" method="get" id="regForm"
                          enctype="multipart/form-data">
                        <h2 class="h2">Timetabler Registration</h2>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <label for="timetablerID" class="label">Timtabler ID (ex:TI0000) :</label>
                                <input type="text" class="form-control" id="timetablerID" name="timetablerID" maxlength="10" required>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <div class="form-group">
                                <label for="email" class="label">Email (ex: TIxxxx@timespace.com):</label>
