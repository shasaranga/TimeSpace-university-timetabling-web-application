...
<%--                        <label class="label">Select Badge (only when user type is "student")</label>--%>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="hidden" value="timetablerStudentView" name="viewType" id="viewType">
        ...
        <c:if test="${Show == true}" >
            ...
            <form action="CourseTimetableServlet" method="get">
                <input type="hidden" name ="action" value="DeleteBadgeTimetable"/>
                <input type="hidden" name ="loggedInUserID" value="<%=currentUser.getTimetablerID()%>"/>
                <input type="hidden" value="${badgeIDVal}" name="badgeIDRec"/>
                <input type="hidden" value="${courseIDVal}" name="courseIDRec"/>
                <button class="form-control btn btn-outline-danger rounded-pill" type="submit">Delete</button>
            </form>
